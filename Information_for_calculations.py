...
def data_base():
    ...
    [sg.Text('Capital Inicial:', justification='left', size=(25, 1), font=('Times New Roman', 18, 'bold'), pad=((0, 10), (5, 10))), 
     sg.Input(key='starting_capital', size=(45, 1), enable_events=True, justification='right', font=('Times New Roman', 16, 'bold'), text_color='black', tooltip='Informe o capital inicial', pad=((0, 0), (5, 10)))],
    [sg.Text('Porcentagem de Juros ao Mês:', justification='left', size=(25, 1), font=('Times New Roman', 18, 'bold'), pad=((0, 10), (5, 10))), 
     sg.Input(key='percentage_fees', size=(45, 1), enable_events=True, justification='right', font=('Times New Roman', 16, 'bold'), text_color='black', tooltip='Informe os juros ao mês (Ex: 10%)', pad=((0, 0), (5, 10)))],
    [sg.Text('Tempo de Investimento:', justification='left', size=(25, 1), font=('Times New Roman', 18, 'bold'), pad=((0, 10), (5, 10))), 
     sg.Input(key='time_in_mounths', size=(45, 1), enable_events=True, justification='right', font=('Times New Roman', 16, 'bold'), text_color='black', tooltip='Informe o Tempo Total de Investimento', pad=((0, 0), (5, 10)))],
    [sg.Text('Nota: Todos os valores devem ser compatíveis com informações ao mês. Se os \nvalores fornecidos estiverem em outra medida de tempo, Comprometerá o Cálculo!', 
             text_color='black', size=(70, 2), font=('Times New Roman', 13, 'bold'), pad=((0, 0), (10, 10)))],
